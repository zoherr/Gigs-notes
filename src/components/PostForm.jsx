...
export default function PostForm({ post }) {
    ...
    const { register, handleSubmit, watch, setValue, reset, formState: { errors } } =
        useForm({
            defaultValues: {
                ...
                semester: post?.semester || "personal",
    ...
    const submit = async (data) => {
        try {
            ...
            setError("There was a problem submitting your post. Please try again.");
            setLoading(false);
        } finally {
            reset();
        }
    ...
    return (
        <>
            ...
            <Navbar />
            {loading ? (
                <div className="w-full sm:my-[10%] my-[40%] text-center">
                    <Loading />
                </div>
            ) : (
                <form
                    ...
                    <div className="space-y-6 px-2">
                        ...
                        <div className="mb-4 text-xl">
                            ...
                            <input
                                type="radio"
                                value="semester"
                                checked={selection === "semester"}
                                onChange={() => setSelection("semester")}
                            />
                        </div>
                        {selection === "semester" && (
                        <>
